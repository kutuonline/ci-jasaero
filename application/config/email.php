...
$config['smtp_host']        = 'mail.jas-aero.com';		// mail server
...
$config['smtp_user']        = 'doni.andriansyah@jas-aero.com';
$config['smtp_pass']        = '28Dayslater';
$config['smtp_port']        = 465; //-- awalnya 587		// port 25, 465, atau 587
$config['smtp_timeout']     = 30;                       // (in seconds)
$config['smtp_crypto']      = 'ssl'; //-- awalnya tls                    // '' or 'tls' or 'ssl'
