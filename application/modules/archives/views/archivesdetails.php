...
<div id="wrapper">
	...
	<section id="content">
        ...
        <!-- Service Blcoks -->
				...
				<p>Below is the news stored in the archive.</p>

				<?php foreach($data_detail as $row1){ ?>
				<a href="<?php echo base_url('news/details/'.$row1->news_slug); ?>">
					<br>
					<li><?php echo $row1->headline; ?></li>
				</a>
				<?php } ?> &nbsp;
