...
<div id="wrapper">
	...
	<section id="content">
        ...
        <!-- Service Blcoks -->
				...
				<p>Below is a news archive based on years.</p>

				<?php foreach($allArchive as $row1){ ?>
				<a href="<?php echo base_url('archives/details/'.$row1->nm_archive); ?>">
					<br>
					<li><?php echo "News archive"; echo "&nbsp;"; echo $row1->nm_archive; ?></li>
				</a>
				<?php } ?> &nbsp;
