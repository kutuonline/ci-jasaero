			...
			<div class="row"> 
				<div class="col-md-12">
					<div class="about-logo">
						...
						<div class="col-md-6">
							<p>Post date : <?php echo tgl_indo($row1->post_date); ?></p>
						</div>
						<div class="col-md-6">
							<p>Closing date : <?php echo tgl_indo($row1->closing_date); ?></p>
						</div>
						<br><br>
						<p><?php echo limit_words($row1->desc_career, 50); ?>...<?php echo anchor('career/details/'.$row1->career_slug,'[read more]'); ?></p>
					</div> 
				</div>
			</div>
